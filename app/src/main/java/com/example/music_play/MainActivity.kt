...
import com.example.music_play.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initializeLayout(){
        ...
        binding.musicRV.setItemViewCacheSize(8)
    ...
    private fun getAllAudio(): ArrayList<music>{
        ...
        if (cursor!=null && cursor.moveToFirst()) {
            do {
                ...
                val music = music(idC,titleC,albumC,artistC,durationC,pathC, artUri = arturiC)
